...
test("getInterviewrsForDay returns an array", () => {
  const result = getInterviewersForDay(state, "Monday");
  expect(Array.isArray(result)).toBe(true);
});

test("getInterviewrsForDay returns an array with a length matching the number of interviewers available for that day", () => {
  const result = getInterviewersForDay(state, "Monday");
  expect(result.length).toEqual(2);
});

test("getInterviewrsForDay returns an array containing the correct interviwer objects", () => {
...
test("getInterviewrsForDay returns an empty array when the days data is empty", () => {
  const result = getInterviewersForDay({ days: [] }, "Monday");
  expect(result.length).toEqual(0);
});

test("getInterviewrsForDay returns an empty array when the day is not found", () => {
